                    ...
                    <div class="li-blog-sidebar-wrapper">
                        ...
                        <div class="li-blog-sidebar">
                            ...
                            <div class="li-recent-post pb-30">
                                <div class="li-recent-post-thumb">
                                    <a href="blog-details-left-sidebar.html">
                                        <img class="img-full" src="${pageContext.request.contextPath}/resource/user/images/product/small-size/3.jpg" alt="Li's Product Image">
                                    </a>
                                </div>
                            ...
                            <div class="li-recent-post pb-30">
                                <div class="li-recent-post-thumb">
                                    <a href="blog-details-left-sidebar.html">
                                        <img class="img-full" src="${pageContext.request.contextPath}/resource/user/images/product/small-size/2.jpg" alt="Li's Product Image">
                                    </a>
                                </div>
                                <div class="li-recent-post-des">
                                    <span><a href="blog-details-left-sidebar.html">First Blog Post</a></span>
                            ...
                            <div class="li-recent-post pb-30">
                                <div class="li-recent-post-thumb">
                                    <a href="blog-details-left-sidebar.html">
                                        <img class="img-full" src="${pageContext.request.contextPath}/resource/user/images/product/small-size/5.jpg" alt="Li's Product Image">
                                    </a>
                                </div>
                                <div class="li-recent-post-des">
                                    <span><a href="blog-details-left-sidebar.html">First Blog Post</a></span>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="li-blog-banner">
                                            <a href="blog-details-left-sidebar.html"><img class="img-full" src="${pageContext.request.contextPath}/resource/user/images/blog-banner/2.jpg" alt=""></a>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="li-blog-content">
                                            <div class="li-blog-details">
                                                <h3 class="li-blog-heading pt-xs-25 pt-sm-25"><a href="${pageContext.request.contextPath}/resource/user/blog-details-left-sidebar.html">blog image post</a></h3>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="li-blog-gallery-slider slick-dot-style">
                                            <div class="li-blog-banner">
                                                <a href="blog-details-left-sidebar.html"><img class="img-full" src="${pageContext.request.contextPath}/resource/user/images/blog-banner/1.jpg" alt=""></a>
                                            </div>
                                            <div class="li-blog-banner">
                                                <a href="blog-details-left-sidebar.html"><img class="img-full" src="${pageContext.request.contextPath}/resource/user/images/blog-banner/2.jpg" alt=""></a>
                                            </div>
